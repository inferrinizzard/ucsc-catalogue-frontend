...
export type UIActions = OpenDrawerAction | OpenLinerAction | UpdateDrawerAction | UpdateLinerAction;
export default function UIReducer(state: UIState = initialState, action: UIActions): UIState {
	switch (action.type) {
